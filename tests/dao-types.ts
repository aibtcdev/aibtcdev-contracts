...
export enum ContractActionType {
  ...
  DAO_ACTION_PAYMENTS_DAO_ADD_RESOURCE = "aibtc-action-pmt-dao-add-resource",
  DAO_ACTION_PAYMENTS_DAO_TOGGLE_RESOURCE = "aibtc-action-pmt-dao-toggle-resource",
  DAO_ACTION_PAYMENTS_SBTC_ADD_RESOURCE = "aibtc-action-pmt-sbtc-add-resource",
  DAO_ACTION_PAYMENTS_SBTC_TOGGLE_RESOURCE = "aibtc-action-pmt-sbtc-toggle-resource",
  DAO_ACTION_PAYMENTS_STX_ADD_RESOURCE = "aibtc-action-pmt-stx-add-resource",
  DAO_ACTION_PAYMENTS_STX_TOGGLE_RESOURCE = "aibtc-action-pmt-stx-toggle-resource",
...
export enum ContractProposalType {
  ...
  DAO_PAYMENTS_DAO_ADD_RESOURCE = "aibtc-pmt-dao-add-resource",
  DAO_PAYMENTS_DAO_SET_PAYMENT_ADDRESS = "aibtc-pmt-dao-set-payment-address",
  DAO_PAYMENTS_DAO_TOGGLE_RESOURCE_BY_NAME = "aibtc-pmt-dao-toggle-resource-by-name",
  DAO_PAYMENTS_DAO_TOGGLE_RESOURCE = "aibtc-pmt-dao-toggle-resource",
  DAO_PAYMENTS_SBTC_ADD_RESOURCE = "aibtc-pmt-sbtc-add-resource",
  DAO_PAYMENTS_SBTC_SET_PAYMENT_ADDRESS = "aibtc-pmt-sbtc-set-payment-address",
  DAO_PAYMENTS_SBTC_TOGGLE_RESOURCE_BY_NAME = "aibtc-pmt-sbtc-toggle-resource-by-name",
  DAO_PAYMENTS_SBTC_TOGGLE_RESOURCE = "aibtc-pmt-sbtc-toggle-resource",
  DAO_PAYMENTS_STX_ADD_RESOURCE = "aibtc-pmt-stx-add-resource",
  DAO_PAYMENTS_STX_SET_PAYMENT_ADDRESS = "aibtc-pmt-stx-set-payment-address",
  DAO_PAYMENTS_STX_TOGGLE_RESOURCE_BY_NAME = "aibtc-pmt-stx-toggle-resource-by-name",
  DAO_PAYMENTS_STX_TOGGLE_RESOURCE = "aibtc-pmt-stx-toggle-resource",
