...
export enum ContractProposalType {
  ...
  DAO_PMT_DAO_ADD_RESOURCE = "aibtc-pmt-dao-add-resource",
  DAO_PMT_DAO_SET_PAYMENT_ADDRESS = "aibtc-pmt-dao-set-payment-address",
  DAO_PMT_DAO_TOGGLE_RESOURCE_BY_NAME = "aibtc-pmt-dao-toggle-resource-by-name",
  DAO_PMT_DAO_TOGGLE_RESOURCE = "aibtc-pmt-dao-toggle-resource",
  DAO_PMT_SBTC_ADD_RESOURCE = "aibtc-pmt-sbtc-add-resource",
  DAO_PMT_SBTC_SET_PAYMENT_ADDRESS = "aibtc-pmt-sbtc-set-payment-address",
  DAO_PMT_SBTC_TOGGLE_RESOURCE_BY_NAME = "aibtc-pmt-sbtc-toggle-resource-by-name",
  DAO_PMT_SBTC_TOGGLE_RESOURCE = "aibtc-pmt-sbtc-toggle-resource",
  DAO_PMT_STX_ADD_RESOURCE = "aibtc-pmt-stx-add-resource",
  DAO_PMT_STX_SET_PAYMENT_ADDRESS = "aibtc-pmt-stx-set-payment-address",
  DAO_PMT_STX_TOGGLE_RESOURCE_BY_NAME = "aibtc-pmt-stx-toggle-resource-by-name",
  DAO_PMT_STX_TOGGLE_RESOURCE = "aibtc-pmt-stx-toggle-resource",
...
export enum TraitType {
  ...
  DAO_BASE_V2 = "aibtc-dao-v2",
  DAO_TRAITS_V2 = "aibtc-dao-traits-v2",
  DAO_BASE_V3 = "aibtc-dao-v3",
  DAO_TRAITS_V3 = "aibtc-dao-traits-v3",
