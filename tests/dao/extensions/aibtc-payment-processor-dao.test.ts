...
const contractAddress = `${deployer}.aibtc-payment-processor-dao`;
...
describe(`public functions: aibtc-payment-processor-dao`, () => {
  ////////////////////////////////////////
  // callback() tests
  ////////////////////////////////////////
...
describe(`read-only functions: aibtc-payment-processor-dao`, () => {
  /////////////////////////////////////////////
