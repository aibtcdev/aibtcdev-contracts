...
const contractAddress = `${deployer}.${ContractActionType.DAO_ACTION_PMT_DAO_ADD_RESOURCE}`;

describe(`action extension: ${ContractActionType.DAO_ACTION_PMT_DAO_ADD_RESOURCE}`, () => {
