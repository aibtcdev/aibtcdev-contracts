...
const contractAddress = `${deployer}.${ContractActionType.DAO_ACTION_PAYMENTS_DAO_ADD_RESOURCE}`;

describe(`action extension: ${ContractActionType.DAO_ACTION_PAYMENTS_DAO_ADD_RESOURCE}`, () => {
