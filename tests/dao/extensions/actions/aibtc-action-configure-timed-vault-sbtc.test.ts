...
const contractAddress = `${deployer}.${ContractActionType.DAO_ACTION_CONFIGURE_TIMED_VAULT_SBTC}`;

describe(`action extension: ${ContractActionType.DAO_ACTION_CONFIGURE_TIMED_VAULT_SBTC}`, () => {
