...
const contractAddress = `${deployer}.${ContractActionType.DAO_ACTION_PAYMENTS_STX_ADD_RESOURCE}`;

describe(`action extension: ${ContractActionType.DAO_ACTION_PAYMENTS_STX_ADD_RESOURCE}`, () => {
