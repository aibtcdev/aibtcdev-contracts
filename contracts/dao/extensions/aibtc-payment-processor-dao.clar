;; title: aibtc-payment-processor-dao
;; version: 1.0.0
...
(impl-trait .aibtc-dao-traits-v3.invoices)
(impl-trait .aibtc-dao-traits-v3.resources)
...
(define-constant CFG_PAYMENT_TOKEN .aibtc-token)
