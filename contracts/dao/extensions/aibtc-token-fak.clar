;; SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.ai1-faktory
...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
    (begin
       ...
       (match (ft-transfer? ai1 amount sender recipient)
          response (begin
            (print memo)
            (ok response))
          error (err error)
